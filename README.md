...
- int: Represents any integer
- uint: Represents unsigned (positive) integers
- print: Prints any string to stdout
- cast: Casts functions to a different type
- add: Adds any number of integers
